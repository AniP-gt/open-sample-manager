...
export function MidiListHeader({
  ...
  const columns = [
    ...
    { key: "musical_role", label: "ROLE", align: "left" as const, color: "#9ca3af" },
    { key: "polyphony", label: "TEXTURE", align: "left" as const, color: "#9ca3af" },
    { key: "bar_count", label: "BARS", align: "right" as const, color: "#9ca3af" },
    { key: "suggested_instrument", label: "INSTRUMENT", align: "left" as const, color: "#9ca3af" },
