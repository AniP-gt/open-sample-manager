              ...
              onClick={() => onSelect(
                {
                  ...
                  sample_type: (r.row.sample_type as Sample["sample_type"]) ?? "one-shot",
                  tags: [],
                  waveform_peaks: r.row.waveform_peaks ? JSON.parse(r.row.waveform_peaks) : null,
                  playback_type: r.row.playback_type as Sample["playback_type"],
                  instrument_type: r.row.instrument_type as Sample["instrument_type"],
                },
                r.row.path,
              )}
              style={{
...
export default EmbeddingResultsModal;
