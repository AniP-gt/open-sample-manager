...
interface DetailPanelProps {
  ...
  // Provide the full samples list to render contextual filter controls (optional)
  samples?: Sample[];
  // Current filter state and change handler (optional) so DetailPanel can render
  // and control the filter UI moved from the main pane.
  filters?: FilterState;
  onFilterChange?: (newFilters: Partial<FilterState>) => void;
  // Optional error callback to surface errors to App-level banner
