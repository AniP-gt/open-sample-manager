interface SettingsModalProps {
  ...
  onShowSampleMetadataQualityChange: (enabled: boolean) => void;
}
      ...
      >
        ...
        <div style={{ marginBottom: "24px" }}>
          ...
          >
            <div>
              <div style={{ fontSize: "14px", color: "#d1d5db" }}>
                Sample metadata and quality UI
              </div>
              <div style={{ fontSize: "12px", color: "#6b7280", marginTop: "4px" }}>
                Show license metadata and quality check controls in the sample list
              </div>
            </div>
            <button
              onClick={() => onShowSampleMetadataQualityChange(!showSampleMetadataQuality)}
              style={{
                width: "44px",
                height: "24px",
                borderRadius: "12px",
                border: "none",
                cursor: "pointer",
                background: showSampleMetadataQuality ? "#f97316" : "#374151",
                position: "relative",
                flexShrink: 0,
                transition: "background 0.2s",
              }}
              aria-checked={showSampleMetadataQuality}
              role="switch"
              aria-label="Sample metadata and quality UI"
            >
              <span
                style={{
                  position: "absolute",
                  top: "3px",
                  left: showSampleMetadataQuality ? "23px" : "3px",
                  width: "18px",
                  height: "18px",
                  borderRadius: "50%",
                  background: "#fff",
