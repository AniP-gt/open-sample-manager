...
const defaultProps: SettingsModalProps = {
  ...
  freesoundWorkspace: {
    credential: "unset", error: null, fetchPreview: vi.fn(), isBusy: false, page: 1, previewUrl: null, query: "", results: [], saveApiKey: vi.fn(), search: vi.fn(), setQuery: vi.fn(), stopPreview: vi.fn(), totalCount: 0, deleteApiKey: vi.fn(), failPreview: vi.fn(), openHomepage: vi.fn(), openRegistration: vi.fn(),
