...
pub(in crate::db::operations::samples) fn row_to_sample(
    ...
    Ok(SampleRow {
        ...
        pack_name: row.get::<_, Option<String>>("pack_name")?,
        license: row.get::<_, Option<String>>("license")?,
        license_url: row.get::<_, Option<String>>("license_url")?,
        license_memo: row.get::<_, Option<String>>("license_memo")?,
        imported_at: row.get::<_, Option<String>>("imported_at")?,
        peak_db: row.get::<_, Option<f64>>("peak_db")?,
        rms_db: row.get::<_, Option<f64>>("rms_db")?,
        leading_silence_ms: row.get::<_, Option<f64>>("leading_silence_ms")?,
        clipping_count: row.get::<_, Option<i64>>("clipping_count")?,
        channel_count: row.get::<_, Option<i64>>("channel_count")?,
        bit_depth: row.get::<_, Option<i64>>("bit_depth")?,
        quality_flags: row.get::<_, Option<String>>("quality_flags")?,
